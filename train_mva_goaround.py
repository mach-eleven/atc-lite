...
def add_arguments(parser):
    ...
    parser.add_argument('--num-airplanes', type=gt_0, default=0, help='Number of airplanes to train with')
    parser.add_argument('--scenario', type=str, default='MvaGoAroundScenario', help='Scenario to use for training')
...
if __name__ == "__main__":
    ...
    # Pass both scenario and num_airplanes to training functions
    match args.model:
        case 'curr':
            from train_src.functions import train_curriculum
            # Override num_airplanes param for curriculum training
